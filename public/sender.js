...
(function () {
  ...
  document
    .querySelector("#peersender-start-con-btn")
  ...
  function shareFile(metadata, buffer, progress_node, filename) {
    ...
    socket.on("fs-share", function () {
      ...
      if (chunk.length != 0) {
        ...
        progress_node.innerText = "Downloaded";
      }
    });
  }
})();
